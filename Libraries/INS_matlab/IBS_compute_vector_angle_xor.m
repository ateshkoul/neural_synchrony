function vec_angle = IBS_compute_vector_angle_xor(V1,V2)
...
% select quadants
vec_angle((vec_angle>0 & vec_angle<90) | (vec_angle>180  & vec_angle<270)) = nan;
...
vec_angle(vec_angle>=180) = 270-vec_angle(vec_angle>=180);
