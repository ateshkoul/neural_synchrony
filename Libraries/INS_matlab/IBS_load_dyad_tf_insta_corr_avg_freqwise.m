...
function [insta_correlation,conditions,save_fname,insta_correlation_dyad] = IBS_load_dyad_tf_insta_corr_avg_freqwise(data_analysis_type,Dyads,selected_conditions,analysis_sub_type)
%% Atesh
% 23-12-2020
...
%     save_fname = [analysis_save_dir sprintf('Dyd_%0.1d_insta_corr_avg_freqwise_.mat',Dyads(Dyad))];
%     save_fname = [analysis_save_dir sprintf('Dyd_%0.1d_insta_corr_avg_freqwise_50.mat',Dyads(Dyad))];
