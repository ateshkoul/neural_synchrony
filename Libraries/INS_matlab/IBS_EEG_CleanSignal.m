function [data_ica_clean_S1,data_ica_clean_S2] = IBS_EEG_CleanSignal(dataset_filt,remove_segments)
...
[ data_ica_clean_S1, Rem_Cmp ] = Giac_AK_EEG_ICA( dataset_clean, 20, [-30 30], 'IBS_S1_layout_64.mat',eeg_channels,non_eeg_channels);


eeg_channels = {'2-*','-2-EXG*'};
non_eeg_channels = '2-EXG1';
[ data_ica_clean_S2, Rem_Cmp ] = Giac_AK_EEG_ICA( dataset_clean, 20, [-30 30], 'IBS_S2_layout_64.mat',eeg_channels,non_eeg_channels);
