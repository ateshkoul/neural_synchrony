function IBS_save_datasets_tf_within(Dyad_no,data_ica_clean_S1_tf,data_ica_clean_S2_tf,data_cleaning,processed_dir)
...
switch(data_cleaning)
    ...
    case {'no_aggressive_ASR_clean_trialwise_CAR','no_aggressive_ASR_clean_trialwise_NoCAR'}
        save([processed_dir sprintf('Dyd_%0.2d_trialwise_within_time_freq_',Dyad_no) data_cleaning '.mat'],...
    ...
    case 'no_aggressive_CAR_ASR_5_ICA_appended_trials'
        save([processed_dir sprintf('Dyd_%0.2d_trialwise_within_CAR_ASR_5_ICA_time_freq_',Dyad_no) data_cleaning '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf','-v7.3')
        
    case 'no_aggressive_CAR_ASR_10_ICA_appended_trials'
        save([processed_dir sprintf('Dyd_%0.2d_trialwise_within_CAR_ASR_10_ICA_time_freq_',Dyad_no) data_cleaning '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf','-v7.3')
end
end