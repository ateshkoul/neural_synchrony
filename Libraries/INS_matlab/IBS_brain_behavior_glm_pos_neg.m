function [glm_result_pos,glm_result_neg] = IBS_brain_behavior_glm_pos_neg(data_analysis_type,analysis,condition,analysis_sub_type,output)
if nargin <5
    output = 'plots';
...
save_fname = [save_dir cond_name '_auto_joint_pos_neg.mat'];
...
if exist(save_fname,'file')
    load(save_fname,'glm_result_pos','glm_result_neg','analysis','data_analysis_type','analysis_sub_type','behaviors','behav_analysis')
%         lme_cluster_1_data_pos = glm_result_pos.stats_cell{1}.Variables;
%         writetable(lme_cluster_1_data_pos,[cond_name '_lme_cluster_1_data_pos.csv'])
%     
%     
%         lme_cluster_2_data_pos = glm_result_pos.stats_cell{2}.Variables;
%         writetable(lme_cluster_2_data_pos,[cond_name '_lme_cluster_2_data_pos.csv'])
%         
%         lme_cluster_3_data_pos = glm_result_pos.stats_cell{3}.Variables;
%         writetable(lme_cluster_3_data_pos,[cond_name '_lme_cluster_3_data_pos.csv'])
%         
%         lme_cluster_1_data_neg = glm_result_neg.stats_cell{1}.Variables;
%         writetable(lme_cluster_1_data_neg,[cond_name '_lme_cluster_1_data_neg.csv'])
%     
%     
%         lme_cluster_2_data_neg = glm_result_neg.stats_cell{2}.Variables;
%         writetable(lme_cluster_2_data_neg,[cond_name '_lme_cluster_2_data_neg.csv'])
% 
%         lme_cluster_3_data_neg = glm_result_neg.stats_cell{3}.Variables;
%         writetable(lme_cluster_3_data_neg,[cond_name '_lme_cluster_3_data_neg.csv'])
else
    Dyads = 1:23;
    ...
    behav_analysis = 'joint_positive';
    behavior_data_pos  = IBS_brain_behavior_get_behavioral_data(data_analysis_type,analysis,behaviors,Dyads,condition,behav_analysis,analysis_sub_type);
    
    
    behav_analysis = 'joint_negative';
    behavior_data_neg  = IBS_brain_behavior_get_behavioral_data(data_analysis_type,analysis,behaviors,Dyads,condition,behav_analysis,analysis_sub_type);
    ...
    glm_result_pos = IBS_compute_brain_behavior_glm(data_analysis_type,analysis,brain_data,behavior_data_pos);
    glm_result_neg = IBS_compute_brain_behavior_glm(data_analysis_type,analysis,brain_data,behavior_data_neg);
    ...
    save(save_fname,'glm_result_pos','glm_result_neg','analysis','data_analysis_type','behaviors','analysis_sub_type',...
        'behav_analysis','-v7.3')
