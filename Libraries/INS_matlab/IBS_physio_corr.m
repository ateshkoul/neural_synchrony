function IBS_physio_corr(analysis_type,behavior,conditions,analysis_sub_type)
%IBS_PHYSIO_CORR 
%
% SYNOPSIS: IBS_physio_corr
%
% INPUT 
%
% OUTPUT 
...
result_fname = [save_dir 'physio_corr.mat'];
...
if exist(result_fname,'file')
    ...
    writetable(avg_over_conditions.avg_over_conditions_table,[save_dir 'physio_corr.csv'])
else
