function vec_angle = IBS_compute_behav_vector_angle_neg(V1,V2)
...
% 
% vec_angle(vec_angle>90) = -vec_angle(vec_angle>90)
% 
% vec_angle = vec_angle-45;
% 
% vec_angle = vec_angle./180;

vec_angle = atan2d(V2,V1)+45 ;
