function IBS_brain_behav_plot_glm_coeff(data_analysis_type,analysis,glm_result,plot_title,cond_name)
...
set(gca, 'XTickLabel', {xtl_eye xtl_body xtl_smiling }, 'TickLabelInterpreter', 'latex');
...
exportgraphics(gcf,[save_dir '\\' cond_name '_coefficient_smile_cor7_' plot_title '.eps'],'BackgroundColor','none','ContentType','vector')
end