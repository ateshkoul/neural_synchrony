function [correlation] = IBS_power_correlation(data_pwr_struct1,data_pwr_struct2)
...
%     correlation(chan,band,trial) =  diag(corr(squeeze(data_pwr_struct1.powspctrm(trial,chan,band,1:end-5)),squeeze(data_pwr_struct2.powspctrm(trial,chan,band,1:end-5))));
    correlation(chan,band,trial) =  diag(corr(Giac_detrend_Vector(squeeze(data_pwr_struct1.powspctrm(trial,chan,band,1:end-5))')',Giac_detrend_Vector(squeeze(data_pwr_struct2.powspctrm(trial,chan,band,1:end-5))')'));
