function [glm_result_AND,glm_result_XOR] = IBS_brain_behavior_glm_binary(data_analysis_type,analysis,condition,analysis_sub_type,output)
if nargin <5
    output = 'plots';
...
% save_fname = [save_dir cond_name '_auto_joint_AND_XOR.mat'];
save_fname = [save_dir cond_name '_auto_joint_smile_cor_AND_XOR.mat'];
save_fname = [save_dir cond_name '_auto_joint_smile_cor_AND_XOR_ori.mat'];
...
if exist(save_fname,'file')
    load(save_fname,'glm_result_AND','glm_result_XOR','analysis','data_analysis_type','analysis_sub_type','behaviors','behav_analysis')
        ...
        writetable(lme_cluster_1_data_AND,[cond_name '_lme_smile_cluster_beta_data_AND_ori.csv'])
    
        lme_cluster_2_data_AND = glm_result_AND.stats_cell{2}.Variables;
        writetable(lme_cluster_2_data_AND,[cond_name '_lme_smile_cluster_gamma_data_AND_ori.csv'])
        
        lme_cluster_3_data_AND = glm_result_AND.stats_cell{3}.Variables;
        writetable(lme_cluster_3_data_AND,[cond_name '_lme_smile_cluster_alpha_data_AND_ori.csv'])
        
        lme_cluster_1_data_XOR = glm_result_XOR.stats_cell{1}.Variables;
        writetable(lme_cluster_1_data_XOR,[cond_name '_lme_smile_cluster_beta_data_XOR_ori.csv'])
    
    
        lme_cluster_2_data_XOR = glm_result_XOR.stats_cell{2}.Variables;
        writetable(lme_cluster_2_data_XOR,[cond_name '_lme_smile_cluster_gamma_data_XOR_ori.csv'])

        lme_cluster_3_data_XOR = glm_result_XOR.stats_cell{3}.Variables;
        writetable(lme_cluster_3_data_XOR,[cond_name '_lme_smile_cluster_alpha_data_XOR_ori.csv'])
else
    Dyads = 1:23;
    ...
    behaviors = {'Eye_tracker_gaze','Smile_auto','video_openpose_landmarks_manual_cleaned'};
