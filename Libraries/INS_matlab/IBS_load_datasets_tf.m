function [IBS_tf_data] = IBS_load_datasets_tf(Dyad_no,data_cleaning,processed_dir)
...
switch(data_cleaning)
    case {'no_aggressive_trialwise_CAR','no_aggressive_trialwise_NoCAR'}
       IBS_tf_data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_time_freq_', Dyad_no) data_cleaning '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');
   case {'aggressive_trialwise_CAR','aggressive_trialwise_NoCAR'}
        IBS_tf_data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_aggressive_time_freq_', Dyad_no) data_cleaning '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');    
    case 'no_aggressive_CAR_ASR_5_ICA_appended_trials'
        IBS_tf_data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_CAR_ASR_5_ICA_time_freq_',Dyad_no) data_cleaning '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');
    case 'no_aggressive_CAR_ASR_10_ICA_appended_trials'
        IBS_tf_data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_CAR_ASR_10_ICA_time_freq_',Dyad_no) data_cleaning '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');
end
% switch(data_cleaning)
% %     case {'no_aggressive_trialwise_CAR','no_aggressive_trialwise_NoCAR'}
% %         save([processed_dir sprintf('Dyd_%0.2d_ICA_blocks_only_neck_artefact_clean_bp_03_95_120s.mat',Dyad_no)],'data_ica_clean_S1','data_ica_clean_S2','-v7.3')
% 
%     case {'no_aggressive_ASR_clean_trialwise_CAR','no_aggressive_ASR_clean_trialwise_NoCAR'}
%         load([processed_dir sprintf('Dyd_%0.2d_trialwise_time_freq_',Dyad_no) data_cleaning '.mat'],...
%             'data_ica_clean_S1_tf','data_ica_clean_S2_tf')
