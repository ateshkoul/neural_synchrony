function [IBS_tf_Data] = IBS_load_clean_IBS_tf_data(Dyad_no,analysis_type,processed_dir)
...
switch(analysis_type)
    case {'no_aggressive_trialwise_CAR','no_aggressive_trialwise_NoCAR'}
         IBS_tf_Data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_time_freq_', Dyad_no) analysis_type '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');
   case {'aggressive_trialwise_CAR','aggressive_trialwise_NoCAR'}
         IBS_tf_Data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_aggressive_time_freq_', Dyad_no) analysis_type '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');    
    ...
    case 'no_aggressive_ASR_re_notch_clean_trialwise_CAR'
         IBS_tf_Data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_ASR_re_notch_time_freq_',Dyad_no) analysis_type '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');
    case 'no_aggressive_ASR_8_clean_trialwise_CAR'
         IBS_tf_Data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_ASR_8_time_freq_',Dyad_no) analysis_type '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');
    case 'no_aggressive_ASR_20_clean_trialwise_CAR'
         IBS_tf_Data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_ASR_20_time_freq_',Dyad_no) analysis_type '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');
    case 'no_aggressive_CAR_ASR_5_ICA_appended_trials'
         IBS_tf_Data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_CAR_ASR_5_ICA_time_freq_',Dyad_no) analysis_type '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');
    case 'no_aggressive_CAR_ASR_10_ICA_appended_trials'
         IBS_tf_Data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_CAR_ASR_10_ICA_time_freq_',Dyad_no) analysis_type '.mat'],...
            'data_ica_clean_S1_tf','data_ica_clean_S2_tf');
%          IBS_tf_Data = load([processed_dir sprintf('Dyd_%0.2d_trialwise_CAR_ASR_10_ICA_time_freq_gamma_200avg_',Dyad_no) analysis_type '.mat'],...
%             'data_ica_clean_S1_tf','data_ica_clean_S2_tf');
end
end
