function ppt = IBS_save_powerpoint_t_stats(analysis_types,ppt,select_string,analysis)

% analysis = 'Connectivity_analysis';
for i = 1:numel(select_string)
    
    select_string_t_effect = [select_string{i} '_t_effects_'];
...
%                 IBS_powerpoint_plots(ppt,save_dir,select_string_fig,analysis_types{j},analysis);
                IBS_powerpoint_plots(ppt,save_dir,select_string_t_effect,analysis_types{j},analysis);
