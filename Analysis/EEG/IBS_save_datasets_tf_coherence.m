function IBS_save_datasets_tf_coherence(Dyad_no,data_coherence,data_cleaning,processed_dir)
...
switch(data_cleaning)
    case {'no_aggressive_trialwise_CAR','no_aggressive_trialwise_NoCAR'}
        save([processed_dir sprintf('Dyd_%0.2d_trialwise_time_freq_coherence', Dyad_no) data_cleaning '.mat'],...
            'data_coherence','-v7.3')
   case {'aggressive_trialwise_CAR','aggressive_trialwise_NoCAR'}
        save([processed_dir sprintf('Dyd_%0.2d_trialwise_aggressive_time_freq_coherence', Dyad_no) data_cleaning '.mat'],...
            'data_coherence','-v7.3')    
...
%         save([processed_dir sprintf('Dyd_%0.2d_trialwise_ASR_re_notch_time_freq_coherence',Dyad_no) data_cleaning '.mat'],...
%             'data_ica_clean_S1_tf','data_ica_clean_S2_tf','-v7.3')
%     case 'no_aggressive_ASR_8_clean_trialwise_CAR'
%         save([processed_dir sprintf('Dyd_%0.2d_trialwise_ASR_8_time_freq_coherence',Dyad_no) data_cleaning '.mat'],...
%             'data_ica_clean_S1_tf','data_ica_clean_S2_tf','-v7.3')
%     case 'no_aggressive_ASR_20_clean_trialwise_CAR'
%         save([processed_dir sprintf('Dyd_%0.2d_trialwise_ASR_20_time_freq_coherence',Dyad_no) data_cleaning '.mat'],...
%             'data_ica_clean_S1_tf','data_ica_clean_S2_tf','-v7.3')
    case 'no_aggressive_CAR_ASR_5_ICA_appended_trials'
        save([processed_dir sprintf('Dyd_%0.2d_trialwise_CAR_ASR_5_ICA_time_freq_coherence',Dyad_no) data_cleaning '.mat'],...
            'data_coherence','-v7.3')
    case 'no_aggressive_CAR_ASR_10_ICA_appended_trials'
        save([processed_dir sprintf('Dyd_%0.2d_trialwise_CAR_ASR_10_ICA_time_freq_coherence',Dyad_no) data_cleaning '.mat'],...
            'data_coherence','-v7.3')
end
end