...
function [stats] = IBS_power_stats_t_test(data_analysis_type,analysis,cor_fun,varargin_table)
...
if exist(cluster_stats_analysis,'file')
    ...
    load(cluster_stats_analysis,'stats','test_cond','data_analysis_type','analysis','cor_fun','test_freq','f_name');
    ...
    save(cluster_stats_analysis,'stats','test_cond','data_analysis_type','analysis','test_freq','f_name','cor_fun');
end


IBS_cluster_plot(stats,cluster_main_effects_analysis,[],varargin_table.plot_type,analysis)
